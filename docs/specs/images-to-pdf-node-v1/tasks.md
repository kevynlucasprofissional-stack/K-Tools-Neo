...
- [x] S7-006 require docs-only spec HEAD CI 5/5 — `ae617e948d5549e3dbca1dbe8d5de19c16555535` / `33670517542`.
- [x] S7-007 add discriminating RED while preserving existing WebP suite — `9ac1c9bcb2974e8d4daf70844a14198e35fe54db` / `33671061268`.
- [x] S7-008 extract shared safe first-frame reader from Slice-6 policy.
- [x] S7-009 refactor WebP→PNG to the shared reader with zero observed semantic regression.
...
- [x] S7-022 integration audit/refactor + compatibility debt classification — `1d9afc40bb7adbb511a1869d25b18058782bcbad` / `33672387118`, 5/5.
- [x] S7-023 exact-head hosted evidence Ubuntu/Windows 3.10/3.13 + xyflow.
- [x] S7-024 ADR/canonical memory closure + terminal closure CI — closure `c3585f5b7f478f53e1c5ef63f72a7b49fbb0cdea` / `33674308145`, 5/5.

Terminal result: **RESOLVIDO / RESOLVED / PROMOTED**.
