# Engineering Journal — Platform Foundation / Research Archive

Archived from the previous `docs/engineering-journal/CURRENT.md` when Durable Execution V1 became the active platform milestone. No historical entries were discarded.
