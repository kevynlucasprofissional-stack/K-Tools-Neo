...
const PERMANENT_CODES=new Set(['DRM_PROTECTED','DRM_DETECTED']);
const TRANSIENT_CODES=new Set([
  'PROCESS_TIMEOUT','PROCESS_ABORTED','DOWNLOAD_FAILED','VERIFY_FAILED','MEDIA_NOT_FOUND','PAGE_CLOSED',
  'CDP_NOT_RUNNING','CDP_CONNECT_FAILED','BROWSER_DISCONNECTED','LESSON_REFRESH_FAILED','LESSON_REFRESH_RECOVERY_FAILED',
  'LESSON_INSPECT_FAILED','POSITION_OBSERVATION_FAILED','POSITION_UNOBSERVABLE',
  'PAGE_CONTENT_FAILED','NEXT_ACTIONABILITY_TIMEOUT','HTTP_403','HTTP_429','NETWORK_RESET','ECONNRESET','ETIMEDOUT','EAI_AGAIN',
]);
